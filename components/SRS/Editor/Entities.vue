<template>
  ...
  <div class="deps border p-3 my-2">
    <h5
      ...
      v-b-toggle="`collapse-entity-${requirement._key}`"
    >
      Entities
    </h5>
    <BCollapse :id="`collapse-entity-${requirement._key}`">
      <div class="entities-form-wrap">
        <div
          class="entity-form d-flex flex-column w-100 mt-3"
        ...
        >
          ...
          <div class="fields-wrap border p-2 d-flex flex-column gap-3">
            ...
            <div
              class="field"
              v-for="(field, fIdx) in entity.fields"
              :key="fIdx"
            >
              <div class="d-flex flex-column justify-content-between">
                ...
                <input
                  class="req-input bg-transparent text-white"
                  name="field-name"
                  v-model="field.name"
                ...
                <input
                  ...
                  v-model="field.type"
                  placeholder="Field type"
                  @keydown.tab="onTabPress(entity.fields, fIdx)"
                />
              </div>
            </div>
            <div class="add-one-btn text-primary text-center gap-2 py-2 mt-3">
              <FaIcon
                icon="plus-circle"
                class="pointer"
                role="button"
      ...
      <div class="add-one-btn text-warning text-center gap-2 py-2 bor">
        <FaIcon
          icon="plus-circle"
          class="pointer fa-2x"
          role="button"
...
const onTabPress = (fields: SRS.FieldSpec[], fieldIndex: number) => {
