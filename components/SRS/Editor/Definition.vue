    ...
    <div class="srs-requirement-definition">
        <div class="d-flex justify-content-between align-content-center gap-4">
            ...
            <div class="remove-one-btn text-danger">
                <FaIcon icon="minus-circle" class="" role="button" @click="emit('delete')" />
            </div>
        </div>
        <div class="d-flex justify-content-between align-content-center gap-4">
            ...
            <div class="remove-one-btn text-danger">
                <FaIcon icon="chevron-down" class="" role="button" @click="opened = !opened"
                    v-b-toggle="`collapse-requirement-${requirement._key}`" :class="{ 'upside-down': opened }" />
            </div>
        </div>
    </div>
</template>
