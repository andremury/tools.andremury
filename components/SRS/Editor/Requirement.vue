<template>
    <div class="srs-requirement-editor position-relative">
        ...
        <p class="text-secondary text-center" v-if="nonFunctional">💡 Non-Functional Requirements define how your system
            should work – like performance,
            security, or usability.</p>
        <p class="text-secondary text-center" v-else>💡 Functional Requirements define what your system needs to
            accomplish - like CRUDs, forms, tasks, and so on.</p>
