...
const emptyObj = () =>
  <SRS.Specification>{
    ...
    sections: {
      ...
      productOverview: emptySection(
        'Product Overview',
        'The overview of my product.'
      ),
      constraints: emptySection(
        'Constraints',
        'The restrictions of this document'
      ),
      functionalRequirements: emptySection(
        'Functional Requirements (FR)',
        'Brief explanation of what are functional requirements in this section.'
      ),
      nonFunctionalRequirements: emptySection(
        'Non Functional Requirements (NF)',
        'Brief explanation of what are non functional requirements in this section.'
      ),
      trackability: emptySection(
        'Trackability',
        'The trackability strategy of this requirements.'
      ),
      modifications: emptySection(
        'Modifications',
        'The rules for modifying this piece of software.'
      ),
      developmentStrategy: emptySection(
        'Development Strategy',
        'How will this software be developed? Methodologies, strategies, etc.'
      ),
      completionCriteria: emptySection(
        'Completion Criteria',
        'All the terms needed to consider this product completed and delivered.'
      ),
    },
    requirements: {
      functional: [],
